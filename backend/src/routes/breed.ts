...
router.get("/api/breed", async (req, res) => {
    try {
  ...
  router.post("/api/breed/add", async (req, res) => {
...
router.delete("/api/breed/delete/:id", async (req, res) => {
  ...
  router.put("/api/breed/update/:id", async (req, res) => {
